...
//        mOption.setWifiActiveScan(true);
    ...
    companion object {
        ...
        private var mInstance: MapLocationHelper? = null
            get() {
                return field ?: MapLocationHelper()
            }
